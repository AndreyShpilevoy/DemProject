...
(13,	'code',		N'[code]код[/code]',																															    1,	'\[code\](.*?)\[\/code\]',					        'IgnoreCase/Compiled/Singleline',		N'<dl class="codebox"><dt>Код: <a onclick="selectCode(this); return false;" href="#">Выделить всё</a></dt><dd><code>&nbsp; &nbsp;&nbsp; &nbsp;${1}</code></dd></dl>',1),
