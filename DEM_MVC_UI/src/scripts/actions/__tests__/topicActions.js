...
describe('topicActions', () => {
  it('should create an action with type "GET_TOPICS_BY_FORUM_ID" to get topic by forum id', () => {
    const forumId = 1;
  ...
  it('should create an action with type "GET_TOPICS_BY_FORUM_ID_SUCCESS" to get topic by forum id on success', () => {
    const forumId = 1;
    const expectedAction = {
